...
> 갱신: 2026-08-16 (4차, 단축어 개편) / 브랜치: **`feat/abbreviation-symbol-trigger`**
> (`feat/v2-moakey-parity` 에서 분기 — 그 브랜치의 PR #21 은 아직 머지 대기)
> **v2.1.0 (build 18) 준비 완료 — 아카이브/제출 전. v2.0.0(17) 은 심사 대기 중.**
...
### 상태: v2.1.0 (build 18) **커밋 완료, 아카이브 전** (2026-08-16)
