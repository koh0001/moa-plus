...
> 갱신: 2026-08-14 (3차, 배포 제출 후) / 브랜치: **`feat/v2-moakey-parity`** / origin 푸시 완료
> **v2.0.0 (build 17) App Store 제출 완료 — 심사 대기. PR #21 은 CI 통과 상태로 머지 대기.**
> 테스트: 전체 408건 통과 (serial, `iPhone 17`). §1-2 판독 규칙 준수할 것.
...
### 상태: v2.0.0 (build 17) **배포 제출 완료** (2026-08-14)
