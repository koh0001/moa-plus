...
struct NewFeaturesModalView: View {
    ...
    private let groups: [FeatureGroup] = [
        ...
        FeatureGroup(title: "진동이 안 될 때 이유를 알려드려요", features: [
            Feature(
                icon: "iphone.radiowaves.left.and.right",
                tint: .orange,
                title: "전체 접근 허용 안내",
                detail: "iOS 는 '전체 접근 허용'이 꺼진 키보드의 진동을 막습니다. 이제 키보드가 그 상태를 확인해, 꺼져 있으면 홈 화면 활성화 카드와 소리 · 진동 설정에 바로 알려드립니다. 키 입력은 외부로 전송되지 않습니다."
            ),
        ]),
